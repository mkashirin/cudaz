...
pub const NVRTC_ERROR_OUT_OF_MEMORY: c_int = 1;
pub const NVRTC_ERROR_PROGRAM_CREATION_FAILURE: c_int = 2;
pub const NVRTC_ERROR_INVALID_INPUT: c_int = 3;
pub const NVRTC_ERROR_INVALID_PROGRAM: c_int = 4;
pub const NVRTC_ERROR_INVALID_OPTION: c_int = 5;
pub const NVRTC_ERROR_COMPILATION: c_int = 6;
pub const NVRTC_ERROR_BUILTIN_OPERATION_FAILURE: c_int = 7;
pub const NVRTC_ERROR_NO_NAME_EXPRESSIONS_AFTER_COMPILATION: c_int = 8;
pub const NVRTC_ERROR_NO_LOWERED_NAMES_BEFORE_COMPILATION: c_int = 9;
pub const NVRTC_ERROR_NAME_EXPRESSION_NOT_VALID: c_int = 10;
pub const NVRTC_ERROR_INTERNAL_ERROR: c_int = 11;
pub const NVRTC_ERROR_TIME_FILE_WRITE_FAILED: c_int = 12;
pub const nvrtcResult = c_uint;
pub extern fn nvrtcGetErrorString(result: nvrtcResult) [*c]const u8;
pub extern fn nvrtcVersion(major: [*c]c_int, minor: [*c]c_int) nvrtcResult;
pub extern fn nvrtcGetNumSupportedArchs(numArchs: [*c]c_int) nvrtcResult;
pub extern fn nvrtcGetSupportedArchs(supportedArchs: [*c]c_int) nvrtcResult;
pub const struct__nvrtcProgram = opaque {};
pub const nvrtcProgram = ?*struct__nvrtcProgram;
pub extern fn nvrtcCreateProgram(prog: [*c]nvrtcProgram, src: [*c]const u8, name: [*c]const u8, numHeaders: c_int, headers: [*c]const [*c]const u8, includeNames: [*c]const [*c]const u8) nvrtcResult;
pub extern fn nvrtcDestroyProgram(prog: [*c]nvrtcProgram) nvrtcResult;
pub extern fn nvrtcCompileProgram(prog: nvrtcProgram, numOptions: c_int, options: [*c]const [*c]const u8) nvrtcResult;
pub extern fn nvrtcGetPTXSize(prog: nvrtcProgram, ptxSizeRet: [*c]usize) nvrtcResult;
pub extern fn nvrtcGetPTX(prog: nvrtcProgram, ptx: [*c]u8) nvrtcResult;
pub extern fn nvrtcGetCUBINSize(prog: nvrtcProgram, cubinSizeRet: [*c]usize) nvrtcResult;
pub extern fn nvrtcGetCUBIN(prog: nvrtcProgram, cubin: [*c]u8) nvrtcResult;
pub extern fn nvrtcGetNVVMSize(prog: nvrtcProgram, nvvmSizeRet: [*c]usize) nvrtcResult;
pub extern fn nvrtcGetNVVM(prog: nvrtcProgram, nvvm: [*c]u8) nvrtcResult;
pub extern fn nvrtcGetLTOIRSize(prog: nvrtcProgram, LTOIRSizeRet: [*c]usize) nvrtcResult;
pub extern fn nvrtcGetLTOIR(prog: nvrtcProgram, LTOIR: [*c]u8) nvrtcResult;
pub extern fn nvrtcGetOptiXIRSize(prog: nvrtcProgram, optixirSizeRet: [*c]usize) nvrtcResult;
pub extern fn nvrtcGetOptiXIR(prog: nvrtcProgram, optixir: [*c]u8) nvrtcResult;
pub extern fn nvrtcGetProgramLogSize(prog: nvrtcProgram, logSizeRet: [*c]usize) nvrtcResult;
pub extern fn nvrtcGetProgramLog(prog: nvrtcProgram, log: [*c]u8) nvrtcResult;
pub extern fn nvrtcAddNameExpression(prog: nvrtcProgram, name_expression: [*c]const u8) nvrtcResult;
pub extern fn nvrtcGetLoweredName(prog: nvrtcProgram, name_expression: [*c]const u8, lowered_name: [*c][*c]const u8) nvrtcResult;
...
pub const __DEPRECATED__ = @compileError("unable to translate macro: undefined identifier `deprecated`"); // /usr/local/cuda-12.6/targets/x86_64-linux/include/nvrtc.h:307:10
...
pub const _nvrtcProgram = struct__nvrtcProgram;
