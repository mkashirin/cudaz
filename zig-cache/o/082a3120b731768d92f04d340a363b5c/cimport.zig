...
pub const __CUDA_DEPRECATED = @compileError("unable to translate macro: undefined identifier `deprecated`"); // /usr/local/cuda-12.6/targets/x86_64-linux/include/cuda.h:71:9
pub const _CONCAT_INNER = @compileError("unable to translate C expr: unexpected token '##'"); // /usr/local/cuda-12.6/targets/x86_64-linux/include/cuda.h:24129:9
